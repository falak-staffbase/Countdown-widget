...
import { CountdownWidgetProps, CountdownWidget } from "./countdown-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <countdown-widget message="world!"></countdown-widget>
   */
  return class CountdownWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): CountdownWidgetProps {
    ...
    public static get observedAttributes(): string[] {
      ...
      return [...defaults, 'dayword','hourword','minuteword','secondword','dayswordplural','hourswordplural',"secondswordplural","minuteswordplural","countdowndate", "expiredmessage","boxescolortext","boxescolorbg","showbackground"];
    }
...
const blockDefinition: BlockDefinition = {
    ...
    factory: factory,
    attributes: ['dayword','hourword','minuteword','secondword','dayswordplural','hourswordplural',"secondswordplural","minuteswordplural",'countdowndate','expiredmessage','boxescolortext',"boxescolorbg","showbackground"],
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Countdown Widget',
    iconUrl: 'https://cc-scripts.staffbase.com/countdown-widget/timer1.png'
};
